...
@blueprint.route('/profiles/<username>', methods=('GET',))
@jwt_optional
...
@blueprint.route('/profiles/<username>/follow', methods=('POST',))
@jwt_required
@marshal_with(profile_schema)
...
@blueprint.route('/profiles/<username>/follow', methods=('DELETE',))
@jwt_required
@marshal_with(profile_schema)
